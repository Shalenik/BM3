#' Bayesian Latent Factor Model for Climate Projections (BM3)
#'
...
#' and factor precisions phiet. Computes deviances per iteration and returns DIC.
#'
...
#'   DIC, deviances, phiep_samples.
#' @importFrom splines ns
#' @importFrom stats rnorm dnorm rgamma
#' @export
BM3 <- function(
        Y, z, T, T1, T2, H, iseed, J, nsim,
        mga = 0.1, mbe = 0.1,
        aep = 0.1, bep = 0.1,
        aet = 0.1, bet = 0.1,
        a1  = 3,   a2  = 3
