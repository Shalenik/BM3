---
title: "Plotting Example Data"
author: "BM3 Package"
date: "2026-01-09"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Plotting Example Data}
...
for (i in seq_along(scenarios)) {
  ...
  matplot(1:nrow(mat), mat, type = "l", lty = 1, col = "black",
  ...
  legend("topright", legend = c("Climate Models", "HadCRUT5 Observations"),
...
```{r plot-results}
post <- posterior_sample(results[[1]])
print(dim(post))
...
for (i in seq_along(scenarios)) {
  ...
  post <- posterior_sample(results[[scenarios[i]]])
  matlines(1:ncol(post), t(post), col = "blue")
  legend("topright", legend = c("Climate Models", "HadCRUT5 Observations", "Posterior Samples"),
